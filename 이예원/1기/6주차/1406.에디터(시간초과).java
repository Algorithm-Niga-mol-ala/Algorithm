	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < M; i++) {
			...
			if (input == 'L') { // 커서를 왼쪽으로 한칸 움직이라는 명령어
				...
				stack1.push(sc.next().charAt(0)); //흠...이러면될까....
